...
class Container_9d6c896f39 extends Nette\DI\Container
{
	...
	protected $wiring = [
		...
		'App\Model\BaseModel' => [['02']],
		'App\Model\Pojistenec' => [['02']],
		...
		'App\Presenters\BasePresenter' => [2 => ['application.3']],
	...
	public function createService02(): App\Model\Pojistenec
	{
		return new App\Model\Pojistenec($this->getService('database.default.explorer'));
	}
	...
	public function createServiceApplication__3(): App\Presenters\HomePresenter
	{
		...
		$service->pojistenecModel = $this->getService('02');
		$service->invalidLinkMode = 5;
		return $service;
	}
	...
	{
		return new Nette\Caching\Storages\SQLiteJournal('D:\IT\htdocs\nette/temp/cache/journal.s3db');
	}


	public function createServiceCache__storage(): Nette\Caching\Storage
	{
		return new Nette\Caching\Storages\FileStorage('D:\IT\htdocs\nette/temp/cache', $this->getService('cache.journal'));
	}


	public function createServiceContainer(): Container_9d6c896f39
	{
		return $this;
	}
	...
	{
		$service = new Nette\Database\Connection('mysql:host=127.0.0.1;dbname=evidence_pojisteni', 'admin', 'njHg*7', []);
	...
	public function createServiceLatte__latteFactory(): Nette\Bridges\ApplicationLatte\LatteFactory
	{
		return new class ($this) implements Nette\Bridges\ApplicationLatte\LatteFactory {
			...
			public function __construct(Container_9d6c896f39 $container)
			{
			...
			public function create(): Latte\Engine
			{
				...
				$service->setTempDirectory('D:\IT\htdocs\nette/temp/cache/latte');
